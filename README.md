...
- Thành viên trong nhóm
  ...
  |4|Nguyễn Thị Thùy Linh |20225354| Phát triển giao tiếp và tích hợp hệ thống: Cấu hình UART1 (MX_USART1_UART_Init) truyền dữ liệu từ STM32 về máy tính; xây dựng định dạng dữ liệu gửi qua UART (khối lượng, UID, thời gian); kiểm tra giao tiếp bằng phần mềm Hercules; hỗ trợ tích hợp các module firmware, quản lý phiên bản Git/GitHub, kiểm thử toàn bộ hệ thống và chuẩn bị demo.|
