...
3.1. Các hàm bổ trợ chuyển đổi BCD
```cpp
 ...
 */
```
3.3. Hàm RTC_SetTimeFromCompiler()
```cpp
...
*/
```
**7.Khối khởi tạo màn hình LCD (SPI5 và ILI9341)**\


7.1. Các hàm điều khiển hiển thị LCD
